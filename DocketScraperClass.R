...
DocketScraper <- setRefClass("DocketScraper", fields = list(remoteDriver = 'remoteDriver'))

DocketScraper$methods(selectSearchType = function(desiredSearchType) {
...
DocketScraper$methods(selectCount = function(desiredCounty) {
  parentNode <- "#ctl00_ctl00_ctl00_cphMain_cphDynamicContent_cphDynamicContent_"
...
####Scrape Docket method####
DocketScraper$methods(scrapeForDockets = function(id, lastName, firstName, dateOfBirth) {
...
####Clean HTML Table method####
DocketScraper$methods(cleanScrapedTable = function(searchResults) {
  nthRow <- 7
...
DocketScraper$methods(getSearchResults = function(pageElement, lastName, firstName, dateOfBirth) {
...
DocketScraper$methods(downloadDocket = function(docketURL, id, rowNum, downloadFolderPath) {
